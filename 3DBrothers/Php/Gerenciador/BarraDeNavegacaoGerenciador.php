...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="Css/BarraNavegacaoGerenciador.css">
    ...
    <body>
        <header>
            ...
            <script type="text/javascript" src="Javascript/JavascriptGer.js"></script>
        </header>
